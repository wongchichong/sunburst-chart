...
const Sunburst = Kapsule
    // <{
    // chartId: number, radiusScale: ReturnType<typeof scalePow>,
    // angleScale: ReturnType<typeof scaleLinear<number, number, never>>,
    // arc: ReturnType<typeof d3Arc>
    ...
    ({
        ...
        props: {
            ...
            color: { default: (d, n) => 'lightgrey' as string },
            strokeColor: { default: (d, n) => 'white' as string },
            ...
            tooltipContent: { default: (d, node) => '' as string, triggerUpdate: false },
